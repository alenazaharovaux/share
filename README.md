...
| [bert-family](skills/bert-family/) | Run BERT tools on your own text without a terminal — pull out entities (banks, companies, people, places) with NER, or group texts into topics with BERTopic. Handles transcripts, chat exports, spreadsheets. Multilingual by default. Bilingual (EN + RU). By [Alena Zakharova](https://github.com/alenazaharovaux) (MIT) |
...
| [bert-family](skills/bert-family/) | Запускает инструменты BERT на твоих текстах без терминала — вытаскивает сущности (банки, компании, людей, места) через NER или раскладывает тексты по темам через BERTopic. Понимает транскрипты, выгрузки переписки, таблицы. По умолчанию многоязычный. Двуязычный (EN + RU). Автор: [Алена Захарова](https://github.com/alenazaharovaux) (MIT) |
