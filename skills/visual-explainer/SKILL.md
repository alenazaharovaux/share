...
**Open in browser**:
- macOS: `open [output_dir]/filename.html`
- Linux: `xdg-open [output_dir]/filename.html`
- Windows: `start [output_dir]/filename.html`
...
*Extended with journalism, newsroom, and academic design sensibilities by [Alena Zakharova](https://github.com/alenazaharovaux)*
